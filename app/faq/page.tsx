...
export const metadata: Metadata = {
  title: "Perguntas Frequentes — Personal Trainer Alphaville",
  description:
    "Tire suas dúvidas sobre personal trainer em Alphaville: resultados, preços, consultoria online e presencial, lesões e como começar. Respostas diretas do Montinho PT.",
  alternates: {
    canonical: `${SITE_URL}/faq`,
  },
  openGraph: {
    title: "Perguntas Frequentes — Personal Trainer Alphaville | Montinho PT",
    description:
      "Tire suas dúvidas sobre personal trainer em Alphaville: resultados, preços, consultoria online e presencial, lesões e como começar.",
    url: `${SITE_URL}/faq`,
    type: "website",
  },
};
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: "Perguntas Frequentes", item: `${SITE_URL}/faq` },
  ],
};
      ...
      <section className="py-16 border-t border-white/10 text-center" style={{ background: "#0d0d0d" }}>
        <div className="max-w-xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <a
            ...
            aria-label="Enviar mensagem pelo WhatsApp para o Montinho Personal Trainer"
          >
