    ...
    <>
      ...
      <section className="pt-20 pb-16 bg-black border-b border-white/10">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <a
            href={getWhatsAppUrl("Olá! Moro em Tamboré ou Barueri e tenho interesse em personal trainer na região.")}
            target="_blank"
      ...
      <section className="py-20 bg-black border-t border-white/10">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href={getWhatsAppUrl("Olá! Moro em Tamboré/Barueri e quero saber mais sobre personal trainer na região.")}
              target="_blank"
              rel="noopener noreferrer"
