...
export interface Lead {
  ...
  owner_id: string | null; next_action: string | null; next_action_at: string | null; last_contact_at: string | null; first_response_at: string | null; last_reply_at: string | null; reply_handled_at: string | null; em_paz_at: string | null;
