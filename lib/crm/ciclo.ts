...
export const GRUPOS_FOLLOW_UP = new Set(["parado", "proposta_sem_follow_up", "negociacao_antiga", "follow_up_atrasado", "follow_up_hoje", "proxima_acao_vencida", "renovacao_vencida", "renovacao_proxima", "renovacao_pacote"]);
