  ...
  return (
    <>
      ...
      <section className="py-16 bg-black">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {filtered.length === 0 ? (
            <p className="text-gray-400 text-center py-16">Nenhum artigo nesta categoria.</p>
          ) : (
                  ...
                  <Link href={`/blog/${post.slug}`} className="block p-8">
                    ...
                    <div className="flex items-center justify-between">
                      <span className="text-gray-400 text-xs">
                        {post.updatedAt && post.updatedAt !== post.date ? "Atualizado em " : ""}
                        {new Date((post.updatedAt ?? post.date) + "T12:00:00").toLocaleDateString("pt-BR", {
                          day: "numeric",
                          month: "long",
                          year: "numeric",
                        })}
