  ...
  return (
    <section className="relative min-h-screen flex items-end lg:items-center justify-center overflow-hidden bg-black">
      ...
      {/*
        ...
        pt-20 (80px) ultrapassa a folga: a seção cresce um pouco e o conteúdo
        desce, deixando ~79px livres abaixo do header — medido, não estimado. No
        desktop o lg:py-32 continua mandando, onde nunca houve o problema.
      */}
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-16 pt-20 sm:pt-24 lg:py-32 text-center lg:text-left">
        {/* Eyebrow */}
