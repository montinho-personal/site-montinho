        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          ...
          <div>
            <Link href="/" className="inline-block mb-4">
              <span
                className="text-white text-2xl font-bold tracking-tight block"
                style={{ fontFamily: "var(--font-playfair), Georgia, serif" }}
              >
                Montinho
              </span>
              <span className="text-gray-500 text-xs tracking-[0.15em] uppercase font-medium">
                Personal Trainer
              </span>
            </Link>
          ...
          <div>
            ...
            <div className="flex flex-col gap-4">
              ...
              >
                ...
                <span className="text-sm">@montinhopt</span>
              </a>
            </div>
          </div>
        </div>
